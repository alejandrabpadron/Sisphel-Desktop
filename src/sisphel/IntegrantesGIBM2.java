...
public class IntegrantesGIBM2 extends javax.swing.JFrame {

    public IntegrantesGIBM2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/MarioNegrette.png"))); // NOI18N

        jLabel18.setFont(new java.awt.Font("MS Gothic", 1, 24)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(100, 204, 240));
        jLabel18.setText("Luisa Jiménez Vidal");
        ...
        jLabel12.setText("Auxiliar de Investigación. Ingeniera Biológica de la Universidad Nacional. Amplia experiencia en laboratorios de docencia e investigación a nivel académica");

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel13.setText("y empresarial. Actualmente trabaja en el análisis y documentación de resultados experimentales en proyectos de investigación de evaluación de daño");

        jLabel14.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel14.setText("genotoxico y citotóxico.");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/LuisaJimenezVidal.png"))); // NOI18N

        jLabel19.setFont(new java.awt.Font("MS Gothic", 1, 24)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(100, 204, 240));
        jLabel19.setText("Mario Negrette Guzmán");

        jPanel3.setBackground(new java.awt.Color(255, 255, 255));

        jLabel16.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel16.setText("Docente Investigador, Químico de la Universidad de Córdoba, Magister y Doctor en Ciencias Bioquímicas de la Universidad Nacional Autónoma de México.");

        jLabel17.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel17.setText("Docente en el área de la Bioquímica desde 2006. Autor y co-autor de varias publicaciones enfocadas hacia la promoción del uso de antioxidantes en");

        jLabel20.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel20.setText("diferentes alteraciones fisiológicas; estudios preclínicos en los que se han evaluado efectos citoprotectores y antitumorales y los mecanismos de acción");

        jLabel21.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel21.setText("de pequeñas moléculas como el sulforafano y la curcumina.");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntegrantesGIBM2().setVisible(true);
            }
        });
    }
