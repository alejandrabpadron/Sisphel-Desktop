...
public class PrestarArea extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmb_busequi.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Equipo", "Area" }));
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        if (txt_codunisinu.getText().length() == 0 || txt_equipo.getText().length() == 0 || txt_horaprestamo.getText().length() == 0 || txt_horadev.getText().length() == 0 || txt_fecha.getText().length() == 0) {
            ...
            int x = JOptionPane.showConfirmDialog(null, "¿Desea Prestar La Sala Por: " + hora + ":" + minuto + ":" + segundo + "  Hora(s)");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrestarArea().setVisible(true);
            }
        });
    }
