...
public class IntegrantesGIBM4 extends javax.swing.JFrame {

   
    public IntegrantesGIBM4() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/pedro.png"))); // NOI18N

        jLabel18.setFont(new java.awt.Font("MS Gothic", 1, 24)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(100, 204, 240));
        jLabel18.setText("Shirley Salcedo Arteaga");
        ...
        jLabel12.setText("Investigador COLCIENCIAS, adscrito al Grupo de Investigaciones Biomédicas y Biología Molecular (GIBM) de la Universidad del Sinú. ");

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel13.setText("Químico egresado de la Universidad de Córdoba, estudiante de MSc en Ciencias Biológicas: Bioquímica de la Universidade Federal do Rio Grande do Sul,");

        jLabel14.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel14.setText(" Brasil (UFRGS). Co-investigador con participación activa en proyectos de investigación actualmente vigentes en las áreas de Toxicologia Ambiental y ");

        jLabel20.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel20.setText("Genética Toxicológica, relacionados con el estudio de los efectos producidos por genotóxicos como polvo de carbón y metilmercurio en poblaciones");

        jLabel21.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel21.setText("humanas con exposición ambiental.");

        javax.swing.GroupLayout jPanel2Layout = new javax.swing.GroupLayout(jPanel2);
        jPanel2.setLayout(jPanel2Layout);
        jPanel2Layout.setHorizontalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel13, javax.swing.GroupLayout.DEFAULT_SIZE, 1066, Short.MAX_VALUE)
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ShirleySalcedo.png"))); // NOI18N

        jLabel19.setFont(new java.awt.Font("MS Gothic", 1, 24)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(100, 204, 240));
        jLabel19.setText("Pedro Espitia Pérez");
        ...
        jLabel15.setText("Docente Investigador, Bióloga de la Universidad de Córdoba. Magister en Biología con énfasis en Genética y Bioquímica.");

        jLabel16.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel16.setText("Trabaja en el área de Mutagénesis Carcinogénesis con biomarcadores moleculares para el estudio in vivo e in vitŕo de sistemas biológicos expuestos");

        jLabel17.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel17.setText("a agentes citotóxicos y genotoxicos.");

        javax.swing.GroupLayout jPanel3Layout = new javax.swing.GroupLayout(jPanel3);
        jPanel3.setLayout(jPanel3Layout);
        jPanel3Layout.setHorizontalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel16, javax.swing.GroupLayout.DEFAULT_SIZE, 1066, Short.MAX_VALUE)
    ...
    private void btn_antActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_antActionPerformed
        IntegrantesGIBM3 integrantes = new IntegrantesGIBM3();
        integrantes.setVisible(true);
        IntegrantesGIBM4.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntegrantesGIBM4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntegrantesGIBM4().setVisible(true);
            }
        });
    }
