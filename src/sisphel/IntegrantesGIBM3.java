...
public class IntegrantesGIBM3 extends javax.swing.JFrame {

 
    public IntegrantesGIBM3() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ClaudiagaleanoPaez.png"))); // NOI18N

        jLabel18.setFont(new java.awt.Font("MS Gothic", 1, 24)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(100, 204, 240));
        jLabel18.setText("Karina Pastor Sierra");

        jLabel9.setFont(new java.awt.Font("MS Gothic", 0, 34)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 102, 0));
        jLabel9.setText("NUESTROS INTEGRANTES");
        jLabel9.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel12.setText("Docente Investigador, Bióloga de la Universidad  de Córdoba, Magister en Biotecnología de la Universidad  de Córdoba.");

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel13.setText("Docente en el área de Biología Celular y Molecular, Metodología de la investigación, Biotecnología en la Universidad del Sinú. Autor y co-autor de varias ");

        jLabel14.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel14.setText("publicaciones indexadas en diversos campos como Genotoxicidad, Zoología y Salud. Ha participado como Investigador y Co-investigador en proyectos ");

        jLabel15.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel15.setText("en las líneas Mutagénesis, Carcinogénesis y de Salud Pública relacionadas con la exposición a la minería de carbón y oro en la Región Caribe Colombiana.");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Karinapastor.png"))); // NOI18N

        jLabel19.setFont(new java.awt.Font("MS Gothic", 1, 24)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(100, 204, 240));
        jLabel19.setText("Claudia Galeano Páez");

        jPanel3.setBackground(new java.awt.Color(255, 255, 255));

        jLabel16.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel16.setText("Docente Investigador, Bióloga de la Universidad de Córdoba, Especialista en Gestión Ambiental, Estudiante de Maestría en Ambiente y Desarrollo de");

        jLabel17.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel17.setText("la Universidad Tecnológica de Bolívar. Trabaja en toxicología y degradación ambiental. Salud Ambiental.");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel16, javax.swing.GroupLayout.PREFERRED_SIZE, 1041, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel17, javax.swing.GroupLayout.PREFERRED_SIZE, 727, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        btn_sig.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/sig - copia.png"))); // NOI18N
        btn_sig.setBorder(null);
        btn_sig.setBorderPainted(false);
        btn_sig.setContentAreaFilled(false);
        btn_sig.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btn_sig.setFocusPainted(false);
        ...
        btn_ant.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ant - copia.png"))); // NOI18N
        btn_ant.setBorder(null);
        btn_ant.setBorderPainted(false);
        btn_ant.setContentAreaFilled(false);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btn_sig, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(btn_ant, javax.swing.GroupLayout.Alignment.TRAILING)))
        );
        ...
        jMenuItem17.setText("LÍNEAS DE INVESTIGACIÓN");
    ...
    private void btn_sigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_sigActionPerformed
        IntegrantesGIBM4 integrantes = new IntegrantesGIBM4();
        integrantes.setVisible(true);
        IntegrantesGIBM3.this.dispose();
    ...
    private void btn_antActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_antActionPerformed
        IntegrantesGIBM2 integrantes = new IntegrantesGIBM2();
        integrantes.setVisible(true);
        IntegrantesGIBM3.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntegrantesGIBM3().setVisible(true);
            }
        });
    }
